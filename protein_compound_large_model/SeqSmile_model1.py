...
class InteractionModel_4(torch.nn.Module):
    def __init__(self, protein_model,smile_model,protein_embd_dim,num_tasks, device,smile_embd_dim, dropout=0.2,aggr = "mean"):
        super( InteractionModel_4, self ).__init__() 
        self.protein_embd_dim=protein_embd_dim
        #self.mol_emb_dim=mol_embd_dim
    ...
    #def forward(self, protein_data,*molecular_data):#******不能有，否则出错
    def forward(self, protein_data,smile_data):#
        ############protein
