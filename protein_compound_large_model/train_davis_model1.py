...
from SeqMolSmile_model1 import InteractionModel_4
...
#num_tasks=1
model= InteractionModel_4(protein_model=protein_model,molecular_model=molecular_model,smile_model=smile_model,protein_embd_dim=320,num_tasks=1,device=device,mol_embd_dim=300,smile_embd_dim=768) 
model.to(device)
...
save_pt='/media/ext_disk/zhenfang/davis/results/model1/without_cross/'
results_save_file='/media/ext_disk/zhenfang/davis/results/model1/without_cross/results.txt'
