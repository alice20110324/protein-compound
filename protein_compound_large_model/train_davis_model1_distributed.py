...
seq_train_dataloader1 = torch.utils.data.DataLoader(seq_train_dataset,sampler=seq_train_sampler, batch_size=args.batch_size, shuffle=False,num_workers=args.num_workers)######False
mol_train_dataloader2 = GeometricDataLoader(gnn_train_dataset, sampler=gnn_train_sampler,batch_size=args.batch_size, shuffle=False,num_workers=args.num_workers)
smile_train_dataloader3=torch.utils.data.DataLoader(smiles_train_dataset,sampler=smiles_train_sampler,batch_size=args.batch_size,collate_fn=collate_fn, shuffle=False,num_workers=args.num_workers)
...
seq_test_dataloader1 = torch.utils.data.DataLoader(seq_test_dataset,sampler=seq_train_sampler, batch_size=args.batch_size, shuffle=False,num_workers=args.num_workers)######False
mol_test_dataloader2 = GeometricDataLoader(gnn_test_dataset, sampler=gnn_train_sampler,batch_size=args.batch_size, shuffle=False,num_workers=args.num_workers)
smile_test_dataloader3=torch.utils.data.DataLoader(smiles_test_dataset,sampler=smiles_train_sampler,batch_size=args.batch_size,collate_fn=collate_fn, shuffle=False,num_workers=args.num_workers)
...
if __name__ == '__main__':
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if args.local_rank == 0:
            if epoch%50==0:
                torch.save(model.module.state_dict(), 'results/davis/model1/model{}.pth'.format(epoch))
