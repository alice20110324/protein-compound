...
def main(local_rank, args):
    ...
    seq_embd_dim=1280
    output_embd_dim=256
    teacher_model=SeqTeacher(1280,256,0.5)
    teacher_model.cuda()
    student_model=SeqMLPStudent(1280,256)
    student_model.cuda()
    ...
    for epoch in range(args.epochs):
        ...
        train(teacher_model, student_model,seq_train_dataloader,teacher_model_optimizer,student_model_optimizer)
    if local_rank == 0:
