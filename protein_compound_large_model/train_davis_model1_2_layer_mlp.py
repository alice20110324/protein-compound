...
from SeqMolSmile_model1_2_layer_mlp import InteractionModel_4,InteractionModel_6
...
#num_tasks=1
model= InteractionModel_6(protein_model=protein_model,molecular_model=molecular_model,smile_model=smile_model,protein_embd_dim=320,num_tasks=1,device=device,mol_embd_dim=300,smile_embd_dim=768) 
model.to(device)
